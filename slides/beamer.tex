...
\begin{tabular}{lcccc}
\toprule
\textbf{Méthode} & \textbf{Principe} & \textbf{Accuracy} & \textbf{Recall} & \textbf{Balanced Accuracy} \\
\midrule
\textbf{RUS} & Réduit la classe majoritaire & 0.956 & 0.959 & 0.956 \\
\textbf{ROS} & Duplique la classe minoritaire & 0.949 & 0.977 & 0.949 \\
\textbf{SMOTE} & Génère des exemples synthétiques & 0.981 & 0.992 & 0.970 \\
\bottomrule
\end{tabular}
\end{block}
